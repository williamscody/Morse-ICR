...
final List<_HelpSection> _helpSections = [
  ...
  _HelpSection(
    ...
    paragraphs: [
      ...
      '- Speech Voice (iOS only): which installed voice speaks the '
          'computer\'s answer. "Auto" (the default) picks the first '
          'higher-quality (Enhanced/Premium) English voice found '
          'installed; choose a specific voice by name instead if you '
          'have more than one installed and want a particular one -- '
          'see Voice Quality below for where to download additional '
          'voices.',
    ],
  ),
  _HelpSection(
  ...
  _HelpSection(
    ...
    paragraphs: [
      'The computer\'s spoken voice comes from your device\'s own '
          ...
          'selected.',
      '- iOS: open Settings > General > Accessibility > Read and Speak '
          '> Voices > English, tap a voice (e.g. Samantha or Nathan), '
          'then tap the ⓘ info button next to it and download the '
          'Enhanced (or Premium, if offered) quality. Once it finishes '
          'downloading, use this app\'s own Settings > Speech Voice to '
          'pick that voice specifically -- leaving it on "Auto" just '
          'picks the first higher-quality English voice found '
          'installed, which may not be the one you meant if more than '
          'one is installed.',
      '- Android: open Settings > Accessibility > Text-to-speech '
          'output -- on some devices it\'s instead under Settings > '
          'System > Languages & input > Text-to-speech output, or on '
          'Samsung devices, Settings > General management > '
          'Text-to-speech (the exact path varies by device) -- and tap '
          'the gear icon next to the preferred engine, usually Google '
          'Text-to-speech Engine. Under Language, choose English '
          ...
          'single named voice equivalent to Samantha, and no in-app '
          '"Speech Voice" picker like iOS has -- whichever voice you '
          'set as the system default here is the one it speaks with.',
    ],
  ),
  _HelpSection(
